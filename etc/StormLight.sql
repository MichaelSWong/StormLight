...
(
	...
	constraint fk_knight_orders_id foreign key (knight_orders_id) references Knight_Orders (knight_orders_id),
	constraint fk_character_id foreign key (character_id) references Character (character_id)
);

INSERT Knight_Orders VALUES ('Order of Windrunners', 'honorspren', 'Adhesion and Gravitation', 'Windrunners.jpg')
INSERT Knight_Orders VALUES ('Order of Skybreakers', ' highspren', 'Gravitation and Division', 'Skybreakers.jpg')
INSERT Knight_Orders VALUES ('Order of Dustbringers', 'honorspren', 'Adhesion and Gravitation', 'Dustbringers.jpg')
INSERT Knight_Orders VALUES ('Order of Edgedancers', 'honorspren', 'Adhesion and Gravitation', 'Edgedancers.jpg')
INSERT Knight_Orders VALUES ('Order of Truthwatchers', 'honorspren', 'Adhesion and Gravitation', 'Truthwatchers.jpg')
INSERT Knight_Orders VALUES ('Order of Lightweavers', 'honorspren', 'Adhesion and Gravitation', 'Lightweavers.jpg')
INSERT Knight_Orders VALUES ('Order of Elsecallers', 'honorspren', 'Adhesion and Gravitation', 'Elsecallers.jpg')
INSERT Knight_Orders VALUES ('Order of Willshapers', 'honorspren', 'Adhesion and Gravitation', 'Willshapers.jpg')
INSERT Knight_Orders VALUES ('Order of Stonewards', 'honorspren', 'Adhesion and Gravitation', 'Stonewards.jpg')
INSERT Knight_Orders VALUES ('Order of Bondsmiths', 'honorspren', 'Adhesion and Gravitation', 'Bondsmiths.jpg')
...
INSERT Character VALUES ('Kaladin Stormblessed', 'Windrunner, Shardbearer', 'Sylphrena', 'Captain of the Bridgemen, Knight Radiant', 'Knights Radiant (Windrunners), Bridge Four, Kholin army, Amaram''s army (formerly), Sadeas army (formerly), Kaladin''s squad (formerly), Takers (formerly)', 'Order of Windrunners','Kaladin.jpg')
INSERT Character VALUES ('Shallan Davar', 'Lightweaver, Shardbearer', 'Pattern', 'Veil, Radiant', 'Knights Radiant (Lightweavers), Ghostbloods', 'Order of Lightweavers', 'Shallan.jpg')
INSERT Character VALUES ('Dalinar Kholin', 'Bondsmith, Old Magic, Shardbearer', 'Stormfather', 'Highprince of Alethkar (formerly), Highprince of War', 'Knights Radiant (Bondsmiths), Kholin army', 'Order of Bondsmiths', 'Dalinar.jpg')
INSERT Character VALUES ('Jasnah Kholin', 'Elsecaller, Shardbearer', 'Ivory', 'Queen of Alethkar', 'Knights Radiant (Elsecallers) Veristitalians', 'Order of Elsecallers', 'Jasnah.jpg')
INSERT Character VALUES ('Lift', 'Edgedancer, Shardbearer, Old Magic', 'Wyndle', 'Thief', '	Huqin''s crew', 'Order of Edgedancers', 'Lift.jpg')


INSERT Book VALUES ('A Way of Kings', 'August 31, 2010', 'I long for the days before the Last Desolation. The age before the Heralds abandoned us and the Knights Radiant turned against us. A time when there was still magic in the world and honor in the hearts of men. The world became ours, and we lost it. Nothing, it appears, is more challenging to the souls of men than victory itself. Or was that victory an illusion all along? Did our enemies realize that the harder they fought, the stronger we resisted? Perhaps they saw that the heat and the hammer only make for a better grade of sword. But ignore the steel long enough, and it will eventually rust away. There are four whom we watch. The first is the surgeon, forced to put aside healing to become a soldier in the most brutal war of our time. The second is the assassin, a murderer who weeps as he kills. The third is the liar, a young woman who wears a scholar’s mantle over the heart of a thief. The last is the highprince, a warlord whose eyes have opened to the past as his thirst for battle wanes. The world can change. Surgebinding and Shardwielding can return; the magics of ancient days can become ours again. These four people are key. One of them may redeem us. And one of them will destroy us.', 'AWayOfKings.jpg')
