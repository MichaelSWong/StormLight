...
(
	...
	titles varchar(1000),
	groups varchar(1000),
	knights_orders_name varchar(100),
	surges varchar(1000),
...
(
	...
	constraint fk_Book_character foreign key(character_id) references Character(character_id)
);
...
(
	...
	character_id int not null,
	knight_orders_name varchar(100),
	spren varchar(50) not null,
	attributes varchar(1000),
	surges varchar(1000),	

	constraint pk_Knight_Orders primary key(knight_orders_id),
	constraint fk_Knight_Orders_character foreign key(character_id) references Character(character_id)
);
